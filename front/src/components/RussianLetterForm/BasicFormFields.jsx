...
import {
  ...
  FORM_LABELS,
  FORM_PLACEHOLDERS,
} from "../../constants/russianLetterForm";
      ...
      <Box sx={{ display: "flex", gap: 2, mb: 3 }}>
        <TextField
          ...
          error={
            ...
            !formData.reference_number.includes("/")
          }
          helperText={
            formData.reference_number &&
            !formData.reference_number.includes("/")
              ? "يجب أن يحتوي الرقم المرجعي على / واحد على الأقل"
              : ""
          }
          sx={{ flex: 1 }}
        />
      ...
      <FormControl fullWidth sx={{ display: "none" }}>
        ...
        >
          {procedures
            .filter(
              (proc) =>
                proc.correspondence_type === formData.type && proc.is_initial
            )
            .map((procedure) => (
