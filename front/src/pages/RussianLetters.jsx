...
import { russianLettersColumns, russianLettersFields } from '../config/russianLettersColumns.js';
...
const RussianLetters = () => {
  ...
  return (
    <Box sx={{ py: 0, px: 3, minHeight: '100vh', backgroundColor: 'background.default' }}>
      {/* Page Header */}
      <Paper sx={{ p: 2, mb: 2, backgroundColor: 'primary.main', color: 'white' }}>
        ...
        <Typography variant="body2" sx={{ opacity: 0.9, mt: 0.5 }}>
          إدارة وعرض جميع الخطابات الواردة من الجهات الروسية
        </Typography>
      </Paper>
